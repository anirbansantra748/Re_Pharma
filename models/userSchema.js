...
const userSchema = new mongoose.Schema({
	...
	profilePicture: {
		type: String,
		default:
			"https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fmir-s3-cdn-cf.behance.net%2Fproject_modules%2Fmax_1200%2F626fd8140423801.6241b91e24d9c.png&f=1&nofb=1",
	},
	...
	medicalRecords: [
		{
			...
			recordType: {
				type: String,
				enum: ["General", "Diabetes", "Heart Disease"],
				required: true,
			},
